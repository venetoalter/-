...
<input name="搜索" type="submit" value="搜索" />
  ...
  <tr ><td  colspan=3  bgcolor="#c0c0c0" align="center" ><h3>请输入您注册时的信息</h3></td> 
    ...
    <tr> 
      ...
      <td width=180> 
        <div  id=msg6 style="color:#ff0000;display:none;">填写如1111111@scut.com的地址</div>
      </td>
    </tr>
  ...
  <td></td><td><h2> ${findUsernull}</h2></td></tr>
   ...
   <div class="footer" align="center"><br />&copy;&nbsp;2022&nbsp;|&nbsp;华南理工大学版权所有 			
					<div align=center>
						电话：86-15163412312&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地址：番禺区xxxx
